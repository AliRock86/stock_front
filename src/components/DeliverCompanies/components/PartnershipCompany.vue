<template>
          ...
          <v-card>
            <v-container grid-list-xs>
              ...
              <v-col>
                ...
                <v-row class="mb-3">
                  <h4 style="color:#000">معلومات الشركه</h4>
                </v-row>
                ...
                <v-row class="mb-2" justify="center">
                  ...
                  <v-col>
                    ...
                    <v-row class="mb-2" ><label> {{item.owner_item.owner_barnd_name}}</label></v-row>
                    <v-row class="mb-2"><label> {{item.owner_item.owner_phone}}</label>  </v-row>
                    <v-row class="mb-2"><label> {{item.owner_item.owner_email}}</label>  </v-row>
 ...
 <v-tabs>
                          <v-tab class="filter_com"  @click="all()">الكل</v-tab>
                            <v-tab class="filter_com"  @click="getAllPartnership(18)">طلبات الشراكه</v-tab>
                            <v-tab class="filter_com"  @click="getAllPartnership(17)">شركات تم التعاقد معها</v-tab>
                         </v-tabs>
        ...
        data: () => ({
            ...
            headers: [{
                ...
                },
                {
                    ...
                    align: 'center',
                    sortable: false,
                    value: 'owner_item.owner_barnd_name',
                },
       ...
       if (result.value) {
          ...
          join_request(item)
          {
            ...
            getCompanies() {
                ...
                var url = "/reservation/delivery/PartnershipCompany";
                this.loading = true;
                this.$http({
                    method: 'get',
                    url: url,
